...
}:
{
  ...
  helium = {
    ...
    version = "0.14.7.1";
    src = fetchurl {
      url = "https://github.com/imputnet/helium-linux/releases/download/0.14.7.1/helium-0.14.7.1-x86_64.AppImage";
  ...
  mango = {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "sha256-f5l8fsEqaX37sw4tAXpKQ4D3MOfrSQyulAvmUJgkqh8=";
    };
  };
  mpv-deletefile = {
  ...
  yt-dlp = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2026.07.04";
      fetchSubmodules = false;
      sha256 = "sha256-+oHcVylLXFJTRR6jXF6IXvgntXJz0tRdtnwTruRPkoc=";
    };
  };
}
